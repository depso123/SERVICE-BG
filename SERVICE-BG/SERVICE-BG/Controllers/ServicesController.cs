...
namespace SERVICE_BG.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CategoryId,Price,Picture")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CategoryId,Price,Picture")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
